...
def main():
    while True:
        ...
        print("3. ⬆️ Upscale video")
        print("4. 🔀 Convert video format")
        print("5. ❌ Exit")
        ...
        if choice == '1':
            ...
            print("\n🔥 Upscaling video... This feature is not implemented yet.\n")
        elif choice == '4':
            print("\n🔥 Converting video format... This feature is not implemented yet.\n")
        elif choice == '5':
